function min_d = polygons_min_dist(P1,P2,Display_solution)
%
...
% min_d = polygons_min_dist(P1,P2,Display_solution);
...
if Npts_P1>1 && Npts_P2>1
    ...
    if ((minP1x < maxP2x) && (maxP1x > minP2x) && ...
        ...
        % S. Hölz function    
        [x,y] = intersections(P1.x,P1.y,P2.x,P2.y);
        if ~isempty(x)
            min_d = 0;
            if Display_solution
                figure
